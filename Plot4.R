...
## set the plot order to rows first and define a 2x2 grid for the plots
par(mfrow=c(2,2))


## create the topleft plot (this is just Plot 2)
with(d,plot(V2,Global_active_power
       ,col = "black"
       ,type = "l"
       ,xlab = ""
...
with(d,plot(V2,Global_reactive_power
            ,col = "black"
            ,type = "l"
            ,xlab = "datetime"
            )
